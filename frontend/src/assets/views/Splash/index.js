    ...
    <>
      ...
      <div className="yourPlace">
        ...
        <div className="yourText">
          ...
          <h3>
            ...
            community, or just a handful of friends that want to spend some time
            together, Shrewdness makes it easy to talk every day and hang out
            more often.
          </h3>
      ...
      <div className="plentyBlock">
        <div className="plentyText">
          ...
          <h3>
            Shrewdness groups are organized into topic-based channels where you
